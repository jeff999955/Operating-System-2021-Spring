...
void f3(void *arg)
{
  ...
  18:	ba450513          	addi	a0,a0,-1116 # bb8 <thread_start_threading+0x38>
  1c:	00000097          	auipc	ra,0x0
  20:	756080e7          	jalr	1878(ra) # 772 <printf>
  24:	71148493          	addi	s1,s1,1809
  28:	00001997          	auipc	s3,0x1
  2c:	b9098993          	addi	s3,s3,-1136 # bb8 <thread_start_threading+0x38>
        if(i == 10005){
  30:	6909                	lui	s2,0x2
  ...
  3a:	b12080e7          	jalr	-1262(ra) # b48 <thread_yield>
        printf("thread 3: %d\n", i++);
  3e:	85a6                	mv	a1,s1
...
void f2(void *arg)
{
  ...
  74:	b5850513          	addi	a0,a0,-1192 # bc8 <thread_start_threading+0x48>
  78:	00000097          	auipc	ra,0x0
  7c:	6fa080e7          	jalr	1786(ra) # 772 <printf>
  80:	4485                	li	s1,1
  82:	00001a17          	auipc	s4,0x1
  86:	b46a0a13          	addi	s4,s4,-1210 # bc8 <thread_start_threading+0x48>
        if (i == 10) {
  8a:	49a9                	li	s3,10
  ...
  94:	ab8080e7          	jalr	-1352(ra) # b48 <thread_yield>
        printf("thread 2: %d\n",i++);
...
void f1(void *arg)
{
 ...
 102:	ada50513          	addi	a0,a0,-1318 # bd8 <thread_start_threading+0x58>
 106:	00000097          	auipc	ra,0x0
 10a:	66c080e7          	jalr	1644(ra) # 772 <printf>
 10e:	06500493          	li	s1,101
 112:	00001a17          	auipc	s4,0x1
 116:	ac6a0a13          	addi	s4,s4,-1338 # bd8 <thread_start_threading+0x58>
        if (i == 110) {
 ...
 126:	a26080e7          	jalr	-1498(ra) # b48 <thread_yield>
        printf("thread 1: %d\n", i++);
...
int main(int argc, char **argv)
{
 ...
 16e:	a16080e7          	jalr	-1514(ra) # b80 <thread_start_threading>
    printf("\nexited\n");
 172:	00001517          	auipc	a0,0x1
 176:	a7650513          	addi	a0,a0,-1418 # be8 <thread_start_threading+0x68>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ee:	50e90913          	addi	s2,s2,1294 # bf8 <thread_start_threading+0x78>
        while(*s != 0){
...
void thread_add_runqueue(struct thread *t){
 ...
 a14:	20a7b823          	sd	a0,528(a5) # c20 <current_thread>
        t->previous = t->next = t;
...
void schedule(void){
 ...
 a28:	1fc78793          	addi	a5,a5,508 # c20 <current_thread>
 a2c:	6398                	ld	a4,0(a5)
...
void thread_exit(void){
 ...
 a46:	1de4b483          	ld	s1,478(s1) # c20 <current_thread>
 a4a:	70dc                	ld	a5,160(s1)
 a4c:	04f48263          	beq	s1,a5,a90 <thread_exit+0x58>
        // TODO
        current_thread->next->previous = current_thread->previous;
 a50:	6cd8                	ld	a4,152(s1)
 a52:	efd8                	sd	a4,152(a5)
        current_thread->previous->next = current_thread->next;
 a54:	70dc                	ld	a5,160(s1)
 a56:	f35c                	sd	a5,160(a4)
        struct thread *tf = current_thread;
        current_thread = current_thread->next;
 a58:	00000717          	auipc	a4,0x0
 a5c:	1cf73423          	sd	a5,456(a4) # c20 <current_thread>
        free(tf->stack);
 a60:	6888                	ld	a0,16(s1)
 a62:	00000097          	auipc	ra,0x0
 a66:	d46080e7          	jalr	-698(ra) # 7a8 <free>
        free(tf->stack_p);
 a6a:	6c88                	ld	a0,24(s1)
 a6c:	00000097          	auipc	ra,0x0
 a70:	d3c080e7          	jalr	-708(ra) # 7a8 <free>
        free(tf);
 a74:	8526                	mv	a0,s1
 a76:	00000097          	auipc	ra,0x0
 a7a:	d32080e7          	jalr	-718(ra) # 7a8 <free>
 ...
 a82:	04e080e7          	jalr	78(ra) # acc <dispatch>
}
 ...
 a96:	d16080e7          	jalr	-746(ra) # 7a8 <free>
        free(current_thread->stack_p);
 a9a:	00000497          	auipc	s1,0x0
 a9e:	18648493          	addi	s1,s1,390 # c20 <current_thread>
 aa2:	609c                	ld	a5,0(s1)
 aa4:	6f88                	ld	a0,24(a5)
 aa6:	00000097          	auipc	ra,0x0
 aaa:	d02080e7          	jalr	-766(ra) # 7a8 <free>
        free(current_thread);
 aae:	6088                	ld	a0,0(s1)
 ab0:	00000097          	auipc	ra,0x0
 ab4:	cf8080e7          	jalr	-776(ra) # 7a8 <free>
        longjmp(env_st, 1);
 ab8:	4585                	li	a1,1
 aba:	00000517          	auipc	a0,0x0
 abe:	17e50513          	addi	a0,a0,382 # c38 <env_st>
 ac2:	00000097          	auipc	ra,0x0
 ac6:	e8a080e7          	jalr	-374(ra) # 94c <longjmp>
 aca:	bf55                	j	a7e <thread_exit+0x46>

0000000000000acc <dispatch>:
void dispatch(void){
 ...
 ad8:	14c53503          	ld	a0,332(a0) # c20 <current_thread>
 adc:	09452783          	lw	a5,148(a0)
 ae0:	ef95                	bnez	a5,b1c <dispatch+0x50>
    if (setjmp(current_thread->env) == 0) {
 ae2:	00000517          	auipc	a0,0x0
 ae6:	13e53503          	ld	a0,318(a0) # c20 <current_thread>
 aea:	02050513          	addi	a0,a0,32
 aee:	00000097          	auipc	ra,0x0
 af2:	e26080e7          	jalr	-474(ra) # 914 <setjmp>
 af6:	c91d                	beqz	a0,b2c <dispatch+0x60>
    current_thread->buf_set = 1;
 af8:	00000797          	auipc	a5,0x0
 afc:	1287b783          	ld	a5,296(a5) # c20 <current_thread>
 b00:	4705                	li	a4,1
 b02:	08e7aa23          	sw	a4,148(a5)
    current_thread->fp(current_thread->arg);
 b06:	6398                	ld	a4,0(a5)
 b08:	6788                	ld	a0,8(a5)
 b0a:	9702                	jalr	a4
 ...
 b10:	f2c080e7          	jalr	-212(ra) # a38 <thread_exit>
}
 b14:	60a2                	ld	ra,8(sp)
 b16:	6402                	ld	s0,0(sp)
 ...
 b26:	e2a080e7          	jalr	-470(ra) # 94c <longjmp>
 b2a:	bf65                	j	ae2 <dispatch+0x16>
        current_thread->env->sp = (unsigned long)current_thread->stack_p;
 b2c:	00000517          	auipc	a0,0x0
 b30:	0f453503          	ld	a0,244(a0) # c20 <current_thread>
 b34:	6d1c                	ld	a5,24(a0)
 b36:	e55c                	sd	a5,136(a0)
        longjmp(current_thread->env, 1);
 b38:	4585                	li	a1,1
 b3a:	02050513          	addi	a0,a0,32
 b3e:	00000097          	auipc	ra,0x0
 b42:	e0e080e7          	jalr	-498(ra) # 94c <longjmp>
 b46:	bf4d                	j	af8 <dispatch+0x2c>

0000000000000b48 <thread_yield>:
void thread_yield(void){
 ...
 b54:	0d053503          	ld	a0,208(a0) # c20 <current_thread>
 b58:	02050513          	addi	a0,a0,32
 b5c:	00000097          	auipc	ra,0x0
 b60:	db8080e7          	jalr	-584(ra) # 914 <setjmp>
 b64:	c509                	beqz	a0,b6e <thread_yield+0x26>
}
 b66:	60a2                	ld	ra,8(sp)
 b68:	6402                	ld	s0,0(sp)
 ...
 b72:	eb0080e7          	jalr	-336(ra) # a1e <schedule>
        dispatch();
 b76:	00000097          	auipc	ra,0x0
 b7a:	f56080e7          	jalr	-170(ra) # acc <dispatch>
}
 b7e:	b7e5                	j	b66 <thread_yield+0x1e>

0000000000000b80 <thread_start_threading>:
void thread_start_threading(void){
 ...
 b8c:	0b050513          	addi	a0,a0,176 # c38 <env_st>
 b90:	00000097          	auipc	ra,0x0
 b94:	d84080e7          	jalr	-636(ra) # 914 <setjmp>
 b98:	c509                	beqz	a0,ba2 <thread_start_threading+0x22>
        return;
    }
    schedule();
    dispatch();
 ...
 ba6:	e7c080e7          	jalr	-388(ra) # a1e <schedule>
    dispatch();
 baa:	00000097          	auipc	ra,0x0
 bae:	f22080e7          	jalr	-222(ra) # acc <dispatch>
 bb2:	b7e5                	j	b9a <thread_start_threading+0x1a>
